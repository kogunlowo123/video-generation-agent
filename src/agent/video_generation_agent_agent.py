"""Video Generation Agent - Main Agent Implementation."""
...
class VideoGenerationAgentAgent:
    """
    ...
    def __init__(self):
        ...
        self._tool_dispatch = {
            "generate_video": self.tools.generate_video,
            "create_thumbnail": self.tools.create_thumbnail,
            "add_captions": self.tools.add_captions,
            "optimize_for_platform": self.tools.optimize_for_platform,
            "manage_assets": self.tools.manage_assets,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['video', 'generation', 'analytics', 'optimization'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "optimize_for_platform": ['optimize', 'for', 'platform'],
