"""Video Generation Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Video content generation agent that creates marketing videos from scripts, generates thumbnails, adds captions and B-roll, optimizes for platform requirements, and manages video assets.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
